...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jun-Hong Cheng"
    user-mail-address "qwe854896@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jhcheng/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jhcheng/bin" "/profile/bin" "/Users/jhcheng/.npm-packages/bin" "/Users/jhcheng/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
